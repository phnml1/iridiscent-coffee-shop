...
String favoratefield = multi.getParameter("favoratefield");
String detailfield = multi.getFilesystemName("detailfield");
int pid = Integer.parseInt(multi.getParameter("pid"));
Coffee coffee = new Coffee(pid, titlefield, namefield, memo, filefield, pricefield,rdate,favoratefield,kind,detailfield);
Connection conn = ConnectionProvider.getConnection();
try {
	CoffeeDao dao = new CoffeeDao();
	dao.update(conn, coffee);
	JdbcUtil.close(conn);
...
<div class="rightcon">
                ...
                <div class="tablestyle">파일이 업로드 되었습니다.<br>
         		...
         		가격: <%= pricefield %><br>
         		종류: <%= kind %><br>
         		선호도: <%= favoratefield %><br>
         		<a href = "list.jsp" >리스트보기</a><br>
         		<a href = "qna.html" >상품 추가</a>
         		</div>
